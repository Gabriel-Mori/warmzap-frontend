  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen">
        <section className="bg-[#F9FAFB] from-green-50 to-white py-20 px-4">
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              <div className="flex-1 space-y-6">
                ...
                <p className="text-xl text-gray-600">
                  WarmZap conecta contas recém-criadas e simula conversas de
                  forma automática, reduzindo as chances de bloqueio e mantendo
                  seus chips ativos.
                </p>
              ...
              <div className="flex-1">
                <div className="relative">
                  <Image src="/sembg.png" height={450} width={450} alt="PIX" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto max-w-6xl">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600">
                  Reduza drasticamente as chances de bloqueio de novos números
                  com nosso sistema de aquecimento.
                </p>
              </div>
